...
import 'scan_manual_reserva_model.dart';
export 'scan_manual_reserva_model.dart';

class ScanManualReservaWidget extends StatefulWidget {
  const ScanManualReservaWidget({
    Key? key,
    this.detailUser,
  }) : super(key: key);
  ...
  @override
  _ScanManualReservaWidgetState createState() => _ScanManualReservaWidgetState();
}

class _ScanManualReservaWidgetState extends State<ScanManualReservaWidget> {
  late ScanManualReservaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScanManualReservaModel());
